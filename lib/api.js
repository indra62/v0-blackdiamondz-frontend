...
export async function getItem(collection, id, params = {}) {
  try {
    ...
    console.log("API URL:", api.getUri({ url: `/items/${collection}/${id}`, ...requestConfig }));
...
export async function getItems(collection, params = {},  headers = {}) {
  try {
...
export async function getUsers(params = {}) {
  try {
    const requestConfig = { params };
    console.log("API URL GET USERS:", api.getUri({ url: `/users/`, ...requestConfig }));
...
export async function saveProperty(userId, propertyId, headers = {}) {
  try {
    const response = await api.post("/items/saved_properties", {
      user_id: userId,
...
export async function deleteSavedProperty(userId, propertyId, headers = {}) {
  try {
    const response = await api.delete("/items/saved_properties", {
      data: {
        user_id: userId,
        property_id: propertyId,
      },
