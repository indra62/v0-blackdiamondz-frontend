...
export function Property({ property, taviraj, archivo, mode = "dark" }) {
    ...
    <>
      <div>
        ...
        <Link
          ...
          className={`block ${mode === "light" ? "#FBF4E4" : "bg-[#211f17]"} overflow-hidden hover:opacity-95 transition-opacity`}
        >
        ...
        <div className="flex justify-between items-center mb-2">
          <div
            className={`${archivo.className} ${mode === "light" ? "text-#9A795F" : "text-[#BD9574]"} font-light text-[16px] leading-[150%]`}
          >
            {translation?.name || ""}
          </div>
          <HeartButton propertyId={property.id} mode={mode} />
        </div>
        ...
        >
          <h3
            className={`${taviraj.className} ${mode === "light" ? "text-[#211F17]" : "text-[#e2dbcc]"} text-[24px] font-light leading-[40px] mb-2 overflow-hidden`}
            style={{
              display: "-webkit-box",
              WebkitLineClamp: 2,
        ...
        {/* Address */}
        <div
          className={`${archivo.className} ${mode === "light" ? "text-#9A795F" : "text-[#BD9574]"} font-light text-[16px] leading-[150%] mb-1`}
        >
          {property.address_street}, {property.address_suburb}
        </div>
        <div
          className={`${archivo.className} ${mode === "light" ? "text-#9A795F" : "text-[#BD9574]"} font-light text-[16px] leading-[150%] mb-4`}
        >
        ...
        {/* Price */}
        <div
          className={`${archivo.className} ${mode === "light" ? "text-[#211F17]" : "text-[#e2dbcc]"} font-bold text-[16px] leading-[150%] mb-6`}
        >{property?.is_auction && (<span className={`font-light ${mode === "light" ? "text-#9A795F" : "text-[#BD9574]"}`}>Auction: </span>)}
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          ...
          >
            ...
            <span className={`${archivo.className} ${mode === "light" ? "text-[#211F17]" : "text-[#e2dbcc]"} font-light text-[14px]`}>
          ...
          >
            ...
            <span className={`${archivo.className} ${mode === "light" ? "text-[#211F17]" : "text-[#e2dbcc]"} font-light text-[14px]`}>
              {findFeature("garages")?.value || findFeature("carports")?.value}
            </span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-0">
          <button className={`py-4 flex items-center justify-center gap-2 ${mode === "light" ? "text-[#211F17] hover:text-[#BD9574]" : "text-[#BD9574] hover:text-[#eea161]"} border border-[#656565] hover:border-[#BD9574]  transition-colors`}>
            <LocationIcon width="22" height="22" />
            <span className={`${archivo.className} font-light text-[16px]`}>
              See map
            </span>
          </button>
          <button className={`py-4 flex items-center justify-center gap-2 ${mode === "light" ? "text-[#211F17] hover:text-[#BD9574]" : "text-[#BD9574] hover:text-[#eea161]"} border border-[#656565] hover:border-[#BD9574] hover:text-[#BD9574] transition-colors`}>
