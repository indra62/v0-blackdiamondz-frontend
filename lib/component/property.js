...
export function Property({ property, taviraj, archivo, dark = true }) {
    ...
    <>
      <div>
        ...
        <Link
          ...
          className={`block ${darkMode ? 'bg-[#211f17]' : 'bg-[#FBF4E4]'} overflow-hidden hover:opacity-95 transition-opacity`}
        >
        ...
        >
          <h3
            className={`${taviraj.className} text-[24px] font-light leading-[40px] mb-2 overflow-hidden ${!darkMode ? 'text-[#211F17]' : 'text-[#e2dbcc]'}` }
            style={{
              display: "-webkit-box",
              WebkitLineClamp: 2,
        ...
        {/* Price */}
        <div
          className={`${archivo.className} text-[16px] font-light leading-[150%] mb-6 ${!darkMode ? 'text-[#211F17]' : 'text-[#E2DBCC]'}` }
        >
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          ...
          >
            ...
            <span className={`${archivo.className} font-light text-[14px] ${!darkMode ? 'text-[#211F17]' : ''}` }>
