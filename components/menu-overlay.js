      ...
      <div className="border-b border-[#656565]/20">
        <div className="container mx-auto px-4">
          <div className="flex items-stretch h-[60px]">
            ...
            <div className="flex items-center px-6 border-r border-[#656565]/20">
              <div className="flex flex-col items-center">
                <Image
                  ...
                  className="w-6 h-6"
                />
                <div className="w-4 h-[2px] bg-[#BD9574] mt-1"></div>
              </div>
            </div>
            ...
            <div className="flex items-center px-6 border-r border-[#656565]/20 min-w-[250px]">
              <div className="flex flex-col w-full">
                ...
                <input
                  ...
                  className="bg-transparent text-[#BD9574] focus:outline-none w-full py-1"
                />
              </div>
            </div>
            ...
            {/* Search Button */}
            <div className="flex items-center px-6 border-r border-[#656565]/20">
              <button className="flex items-center text-[#BD9574] hover:text-[#e5c04b] transition-colors">
            ...
            <div className="flex items-center px-6">
              <button
                onClick={onClose}
                className="text-[#BD9574] hover:text-[#e5c04b] transition-colors"
              >
                <X className="h-6 w-6" />
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <nav className="space-y-6">
              <Link
                href="/buy"
                className="block text-3xl hover:text-[#BD9574] transition-colors"
              >
                Buy
              </Link>
              <Link
          ...
          <div className="space-y-16">
            {/* Newsletter */}
            <div>
              <h3 className="text-sm text-[#656565] mb-4">
                BLACK DIAMONDZ NEWSLETTER
              </h3>
              <div className="space-y-4">
                <h4 className="text-2xl">
                  Subscribe to The Black Diamondz Newsletter
                </h4>
                <div className="flex items-center border-b border-[#656565]">
                  ...
                  />
                  <ArrowRight className="h-4 w-4 text-[#BD9574]" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="text-sm text-[#656565] mb-4">
                    Founder & Director
                  </div>
                  <Link
                    href="tel:0409-898-888"
                    className="block text-[#BD9574] hover:text-[#e5c04b] transition-colors mb-2"
                  >
                    0409-898-888
                  </Link>
                  <Link
