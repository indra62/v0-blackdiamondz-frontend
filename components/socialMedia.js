  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-2 z-40">
        ...
        {/* Facebook Icon */}
        {data?.show_facebook !== false && (
          <a
            href={
              data?.facebook_url ||
              "https://www.facebook.com/blackdiamondzpropertyconcierge"
            }
            target="_blank"
        ...
        {/* Instagram Icon */}
        {data?.show_instagram !== false && (
          <a
            href={
              data?.instagram_url ||
              "https://www.instagram.com/black_diamondz_international"
            }
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#656565] hover:text-[#BD9574] transition-colors"
        ...
        {/* LinkedIn Icon */}
        {data?.show_linkedin !== false && (
          <a
            href={data?.linkedin_url || "https://au.linkedin.com/in/monikatu"}
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#656565] hover:text-[#BD9574] transition-colors"
          >
      ...
      {showWeChatModal && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowWeChatModal(false)}
              className="absolute top-3 right-3 text-[#211F17] hover:text-gray-800"
