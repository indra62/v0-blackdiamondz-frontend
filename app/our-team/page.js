  ...
  return (
    <main className="min-h-screen bg-[#211f17]">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            the forefront of the market, all while providing a bespoke and VIP client offering. With a bilingual
            Chinese-Australian team, and partners in China, Hong Kong, Asia Pacific, Europe and the Middle East, Black
            Diamondz proudly integrates a local global presence with local expertise to ensure that we provide the very
            best solutions to buyers and sellers alike.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-start">
            ...
            <div className="flex flex-col items-center md:items-end text-center md:text-right md:w-1/2 md:pr-12 mb-16 md:mb-0">
              ...
              >
                Monika Tu, Founder and Director of Black Diamondz Group, is a Chinese-Australian executive known for
                bringing global buyers to the Australian property market. She has received multiple accolades, including
                the 2014 Hong Kong Business Association Success Story Award and recognition as a top Chinese
                entrepreneur in Australia (2016). Tu is regarded as Sydney's top luxury real estate agent and an expert
                on the future of Australian real estate.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/2 md:pl-12">
              ...
              <p
                className={`${archivo.className} text-[#BD9574] font-light text-[16px] leading-[150%] tracking-[0px] text-center max-w-md`}
              >
                Jad Khattar is the Co-Director and Founder of Black Diamondz Group. Founded in 2009, it has gained a
                reputation as the top agency for off-market, ultra-high-end Sydney properties. In 2014, the company won
                the International Success Story Award, presented at Parliament House.
              </p>
            </div>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                <td colSpan={2} style={{ width: "402px", height: "200px", padding: 0 }}>
                  <div className="relative w-full h-full">
                    <Image src="/modern-house-exterior.png" alt="Modern house exterior" fill className="object-cover" />
                  </div>
                </td>
                <td style={{ width: "200px", height: "200px", padding: 0 }}>
                  <div className="relative w-full h-full">
      ...
      <section className="py-16 bg-[#211f17]">
        <div className="container mx-auto px-4">
          {/* Heading */}
          <h2 className="font-serif text-[48px] font-light text-[#E2DBCC] text-center mb-8">Support</h2>
          ...
          >
            The Black Diamondz team appreciates your interest in finding the right agency to help you sell your
            property. Our dedicated team members are here to guide you through every step of the process.
          </p>
