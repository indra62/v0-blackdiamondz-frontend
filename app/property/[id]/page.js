...
export default function PropertyDetailPage({ params }) {
  ...
  const initialIndex = album.findIndex((img, idx) => idx === selectedImageId)
  ...
  const handleShowImages = (imageIndex = 0, all = false, full = false) => {
    if (all) {
      setAlbum(allMedia)
    } else {
      setAlbum(imageAlbum)
    ...
    if (full) {
      setCurrentIndex(typeof imageIndex === "number" ? imageIndex : 0)
  ...
  const handleShowPlans = (planIndex = 0, full = false) => {
    setAlbum(plansAlbum)
    setSelectedImageId(typeof planIndex === "number" ? planIndex : 0)
    if (full) {
      setCurrentIndex(typeof planIndex === "number" ? planIndex : 0)
      setLightboxOpen(true)
    } else {
      setViewMode("gallery")
    }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="relative h-56 md:h-64">
                        {property?.images?.[0] && (
                          <div onClick={() => handleShowImages(0, true, true)}>
                            <Image
                              src={getImageUrl(
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="relative h-32 md:h-40">
                          {property?.images?.[1] && (
                            <div
                              onClick={() => handleShowImages(1, true, true)}
                            >
                              <Image
                                src={getImageUrl(
                                ...
                                alt={
                                  property?.images?.[1]?.directus_files_id
                                    ?.title
                                }
                                fill
                                className="transition-transform duration-700 hover:scale-110"
                        ...
                        <div className="relative h-32 md:h-40">
                          {property?.images?.[2] && (
                            <div
                              onClick={() => handleShowImages(2, true, true)}
                            >
                              <Image
                                src={getImageUrl(
                                ...
                                alt={
                                  property?.images?.[2]?.directus_files_id
                                    ?.title
                                }
                                fill
                                className="transition-transform duration-700 hover:scale-110"
                    ...
                    <div className="flex flex-col gap-2">
                      {/* Row 1: Image */}
                      <div className="md:block relative h-56 md:h-64">
                        {property?.images?.[3] && (
                          <div onClick={() => handleShowImages(3, true, true)}>
                            <Image
                              src={getImageUrl(
                      ...
                      <div className="hidden md:block relative h-32 md:h-40">
                        {property?.images?.[4] && (
                          <div onClick={() => handleShowImages(4, true, true)}>
                            <Image
                              src={getImageUrl(
                    ...
                    <>
                      ...
                      <TransformComponent wrapperClass="flex items-center justify-center cursor-grab w-full h-full">
                        <Image
                          ...
                          width={
                            album?.[currentIndex]?.directus_files_id?.width ||
                            1200
                          }
                          height={
                            album?.[currentIndex]?.directus_files_id?.height ||
                            800
                          }
                          className="max-h-[70vh] max-w-[95vw] bg-[#211f17]/70 rounded-md"
                          priority
                          draggable={false}
                          style={{
                            objectFit: "contain",
