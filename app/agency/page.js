    ...
    <main className="min-h-screen bg-[#211f17] text-white">
      ...
      <section className="relative h-[600px]">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            Unlock the potential of your real estate with our expert marketing
            services. We specialize in showcasing your properties to attract the
            right buyers, utilizing innovative strategies and cutting-edge
            technology. Let us help you elevate your listings and maximize your
            sales!
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <p className="mb-6">
                ...
                first step in choosing a preferred agency to secure the sale of
                your property asset.
              </p>
              <p className="mb-6">
                ...
                our local and international expertise to provide them with all
                our clients with the relevant information they require to ensure
                we exceed their expectations.
              </p>
              <p className="mb-6">
                Here we focus on the requirements below before we list or
                showcase their property to the market:
              </p>
              <ul className="list-disc pl-6 mb-6 space-y-2">
                ...
                <li>
                  ...
                  marketing strategies we all areas of the marketing mix.
                </li>
                <li>
                  We leverage our engaged private buyer network locally and
                  internationally to achieve our maximum engagement.
                </li>
              </ul>
              <p className="mb-6">
                Finding the buyers for unique residences is something that Black
                Diamondz Property Concierge has an advantage. We have
                established experience with a vast local and international
                database of high-net-worth private clients. Black Diamondz
                Property Concierge has cultivated strong and trusted personal
                relationships with our clients. This engaged client base are
                successful professionals who turn to us in the pursuit of the
                very best local and international real estate opportunities.
              </p>
              <p className="mb-6">
                As a business we strive to exceed our clients' expectations and
                rigorously follow up all potential buyers and even offer an
                exclusive Property Concierge Service to help interstate and
                international buyers view our private clients properties with
                ease. With our clients' best interests as the primary focus and
                with our team of experts, we leverage our polished negotiation
                skills to allow us to secure timely deals with optimal leading
                results, finding buyers other agencies simply don't have access
                to.
              </p>
              <p className="mb-6">
                We look forward to hearing further about you.
              </p>
              <p className="mb-2">Warmest regards,</p>
              <p className="text-[#BD9574]">
      ...
      <section className="py-20 bg-[#211f17]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              The Black Diamondz team values your interest in partnering with
              the right agency to sell your property. Our committed
              professionals are ready to assist you at every stage of the
              journey.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#1A3541] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=d95s6"
                  alt="Creative Solutions Agency"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
                className={`${archivo.className} text-[#E2DBCC] text-center font-light text-sm mb-1`}
              >
                Creative Solutions
                <br />
                Agency
              ...
              <p
                className={`${archivo.className} text-[#BD9574] text-center font-light text-xs`}
              >
                Fiji
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#2A3240] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=1181f"
                  alt="Elevate Creative"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#E5E5E5] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=nglne"
                  alt="Dynamic Branding Co."
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#B8C7E0] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=gjj6u"
                  alt="Visionary Strategies LLC"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#4A3A8C] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=1nivt"
                  alt="Synergy Communications"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#D9E6E8] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=nnlrt"
                  alt="NextGen Advertising"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#E5E5E5] p-6 mb-4 w-full aspect-square flex items-center justify-center">
                <img
                  src="/placeholder.svg?key=35nrh"
                  alt="Pinnacle Media Partners"
                  className="max-w-full max-h-16"
                />
              </div>
              <h3
